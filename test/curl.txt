curl -i --request POST  --data {"type":"switch","value":1} http://127.0.0.1:3001/devices/1

curl -i --request POST  --data "{\"type\":\"switch\",\"value\":1}" http://127.0.0.1:3001/devices/1

curl -i --request POST  --data "type=switch&value=1" http://127.0.0.1:3001/devices/1
curl -i --request POST  --data "type=step&switch=1&controller=78" http://127.0.0.1:3001/devices/9
====
...
mosquitto_pub -t d1 -h 127.0.0.1 -m "{\"type\":\"switch\",\"value\":0}"

curl -i --request POST  --data "{\"type\":\"switch\",\"value\":1}"  http://192.168.1.1:8080/index.php/mqttdevices/1

curl -i --request POST  --data "{\"type\":\"step\",\"switch\":1,\"controller\":12}"  http://192.168.1.1:8080/index.php/mqttdevices
